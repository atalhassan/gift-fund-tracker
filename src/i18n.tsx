...
const en = {
  ...
  phoneHint: "We'll text you a 6-digit code. New number? We'll create your account.",
  signIn: "Sign in",
  email: "Email",
  password: "Password",
